...
\restrict nbKA4UFsTDh470cRMW6Ik8gPsOR342X5vDDIgOBmWdMrmGVxJgZdseQV87ymTn8
...
CREATE TABLE public.bookings (
    ...
    teachingmode character varying(20),
...
-- Dependencies: 245
-- Name: COLUMN bookings.comboid; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.bookings.comboid IS 'Combo duoc chon tai thoi diem booking.';
...
-- Name: tutorcombofixedslots; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tutorcombofixedslots (
    ...
    createdat timestamp without time zone DEFAULT now(),
    CONSTRAINT ck_tutorcombofixedslots_dayofweek CHECK (((dayofweek >= 1) AND (dayofweek <= 7))),
    CONSTRAINT ck_tutorcombofixedslots_time_range CHECK ((starttime < endtime))
);


ALTER TABLE public.tutorcombofixedslots OWNER TO postgres;

--
-- TOC entry 5829 (class 0 OID 0)
-- Dependencies: 312
-- Name: TABLE tutorcombofixedslots; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.tutorcombofixedslots IS 'Lich co dinh cua combo fixed. Flexible combo khong co ban ghi trong bang nay.';


--
-- TOC entry 311 (class 1259 OID 295624)
-- Name: tutorcombofixedslots_fixedslotid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.tutorcombofixedslots ALTER COLUMN fixedslotid ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.tutorcombofixedslots_fixedslotid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Name: tutorcombos; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tutorcombos (
    comboid integer NOT NULL,
    tutorid character varying(50) NOT NULL,
    name character varying(255) NOT NULL,
    combotype character varying(20) NOT NULL,
    ...
    CONSTRAINT ck_tutorcombos_combotype CHECK (((combotype)::text = ANY ((ARRAY['fixed'::character varying, 'flexible'::character varying])::text[]))),
    CONSTRAINT ck_tutorcombos_duration_positive CHECK ((durationminutespersession > 0)),
    CONSTRAINT ck_tutorcombos_totalsessions_positive CHECK ((totalsessions > 0))
);


ALTER TABLE public.tutorcombos OWNER TO postgres;

--
-- TOC entry 5830 (class 0 OID 0)
-- Dependencies: 310
-- Name: TABLE tutorcombos; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.tutorcombos IS 'Combo hoc fixed/flexible do tutor tao. Booking moi tham chieu combo nay qua bookings.comboid.';


--
-- TOC entry 309 (class 1259 OID 295605)
-- Name: tutorcombos_comboid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.tutorcombos ALTER COLUMN comboid ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.tutorcombos_comboid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.tutorprofiles (
    ...
    teachingmode character varying(20),
    profilestatus character varying(30) DEFAULT 'onboarding_incomplete'::character varying,
    ispublic boolean DEFAULT false,
...
COMMENT ON COLUMN public.tutorprofiles.triallessonprice IS 'Trial lesson price in VND, must be less than or equal to hourlyrate';
...
-- Dependencies: 312
-- Data for Name: tutorcombofixedslots; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 310
-- Data for Name: tutorcombos; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.tutorcombos VALUES (1, '47af5dfe-cd4d-41ed-9c19-74eeb18f2005', 'Codex Flexible Smoke', 'flexible', 2, 60, 'smoke test', true, '2026-06-05 14:41:07.741814', '2026-06-05 14:41:07.741814');
...
-- Dependencies: 311
-- Name: tutorcombofixedslots_fixedslotid_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tutorcombofixedslots_fixedslotid_seq', 1, false);


--
-- TOC entry 5893 (class 0 OID 0)
-- Dependencies: 309
-- Name: tutorcombos_comboid_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tutorcombos_comboid_seq', 1, true);
...
-- Name: tutorcombofixedslots tutorcombofixedslots_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tutorcombofixedslots
    ADD CONSTRAINT tutorcombofixedslots_pkey PRIMARY KEY (fixedslotid);


--
-- TOC entry 5452 (class 2606 OID 295615)
-- Name: tutorcombos tutorcombos_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tutorcombos
    ADD CONSTRAINT tutorcombos_pkey PRIMARY KEY (comboid);
...
-- Name: idx_bookings_comboid; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_bookings_comboid ON public.bookings USING btree (comboid);
...
-- Name: idx_tutorcombofixedslots_combo_day; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_tutorcombofixedslots_combo_day ON public.tutorcombofixedslots USING btree (comboid, dayofweek);


--
-- TOC entry 5450 (class 1259 OID 295665)
-- Name: idx_tutorcombos_tutor_active_type; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_tutorcombos_tutor_active_type ON public.tutorcombos USING btree (tutorid, isactive, combotype);
...
-- Name: bookings fk_bookings_combo; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT fk_bookings_combo FOREIGN KEY (comboid) REFERENCES public.tutorcombos(comboid);
...
--
-- TOC entry 5492 (class 2606 OID 295657)
-- Name: lessons fk_lessons_originallessonid; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lessons
    ADD CONSTRAINT fk_lessons_originallessonid FOREIGN KEY (originallessonid) REFERENCES public.lessons(lessonid);
...
-- Name: tutorcombofixedslots fk_tutorcombofixedslots_combo; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tutorcombofixedslots
    ADD CONSTRAINT fk_tutorcombofixedslots_combo FOREIGN KEY (comboid) REFERENCES public.tutorcombos(comboid) ON DELETE CASCADE;


--
-- TOC entry 5526 (class 2606 OID 295616)
-- Name: tutorcombos fk_tutorcombos_tutor; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tutorcombos
    ADD CONSTRAINT fk_tutorcombos_tutor FOREIGN KEY (tutorid) REFERENCES public.tutorprofiles(tutorid) ON DELETE CASCADE;
...
\unrestrict nbKA4UFsTDh470cRMW6Ik8gPsOR342X5vDDIgOBmWdMrmGVxJgZdseQV87ymTn8
