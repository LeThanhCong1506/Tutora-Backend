...
namespace MV.ApplicationLayer.Services
{
    public partial class UserService : IUserService
    {
        ...
        public async Task<UserResponse> CreateUserAsync(CreateUserRequest request)
        {
            ...
            var encryptedIdentityNumber = !string.IsNullOrEmpty(request.IdentityNumber)
                ? _encryption.Encrypt(request.IdentityNumber)
                : null;
            if (encryptedIdentityNumber != null && !await _unitOfWork.UserRepository.IsIdentityNumberUniqueAsync(encryptedIdentityNumber))
