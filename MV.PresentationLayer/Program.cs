...
// [Tencent RTC - Backup] builder.Services.Configure<TencentRTCSettings>(builder.Configuration.GetSection(TencentRTCSettings.SectionName));
...
// [Tencent RTC - Backup] builder.Services.AddScoped<ITencentRTCService, TencentRTCService>();
